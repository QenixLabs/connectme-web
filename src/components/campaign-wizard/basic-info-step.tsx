...
import { INDIAN_STATES, getCitiesForState } from "@/lib/constants/indian-cities";
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="space-y-3">
        <DateBlock
          ...
          error={(() => {
            const d = errors.dates as unknown as Record<string, { message?: string }>;
        ...
        <DateBlock
          ...
          error={(() => {
            const d = errors.dates as unknown as Record<string, { message?: string }>;
            return d?.end?.message;
          })()}
          onChange={(val) =>
            setValue("dates.end", val, { shouldValidate: true })
          }
        />
        <DateBlock
          ...
          onChange={(val) =>
            setValue("deadline", val, { shouldValidate: true })
          }
