...
export function Topbar() {
  return (
    <header className="sticky top-0 z-10 grid grid-cols-[minmax(0,1fr)_auto] items-center gap-5 border-b border-border bg-bg-surface/95 px-6 py-3.5 backdrop-blur-xl">
      <label
        className="flex min-w-0 max-w-lg items-center gap-2 rounded-xl border border-border bg-bg-surface px-4 py-2.5 text-sm transition-all duration-200 focus-within:border-accent/20 focus-within:shadow-[var(--shadow-search),0_0_0_1px_var(--accent)]"
      >
      ...
      <div className="flex shrink-0 items-center gap-3">
        ...
        <button
          className="flex items-center gap-2 rounded-xl border border-border bg-bg-surface px-3 py-2 text-left transition-all duration-200 hover:bg-bg-surface-inset"
        >
          <img
            src={avatarRahul}
            alt="Rahul Verma"
