    ...
    <div className="space-y-5">
      ...
      {submission.response_text && (
        <div className="space-y-2">
          ...
          <div className="rounded-xl border border-border/60 bg-muted-bg/30 p-4 text-sm text-ink-soft leading-relaxed whitespace-pre-wrap max-h-[300px] overflow-y-auto">
            {submission.response_text}
          </div>
        </div>
      )}
