...
const AVAILABILITY_COLORS: Record<string, string> = {
  ...
  not_available: "bg-slate-100 text-slate-700 border-slate-200",
};
                        ...
                        <TableCell className="py-2.5 sticky left-0 bg-card group-hover:bg-muted/30 z-10">
                          <div className="flex items-center gap-2.5">
                            <Avatar
                              ...
                              size="sm"
                              className="h-7 w-7 text-[10px] shrink-0 ring-2 ring-border group-hover:ring-primary/30 transition-all"
                            />
                            <div className="min-w-0">
                    ...
                    <CardContent className="p-4 space-y-3">
                      <div className="flex items-center gap-3">
                        <Avatar
                          ...
                          src={user.profile_photo}
                          size="md"
                          className="h-10 w-10 text-xs shrink-0 ring-2 ring-border"
                        />
