                ...
                <div className="grid grid-cols-[100px_1fr] gap-y-2 text-xs">
                  ...
                  {log.user_agent && (
                    <>
                      ...
                      <span className="font-mono break-all text-[11px]">{log.user_agent}</span>
                    </>
                  )}
                </div>
              </div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100">
            <ScrollText className="w-4 h-4 text-slate-600" strokeWidth={1.5} />
          </div>
          <div>
            ...
            .map(([action, count]) => (
              <Badge
                ...
                className={`text-[10px] px-2 py-0.5 capitalize ${
                  ACTION_COLORS[action] || "bg-slate-50 text-slate-600 border-slate-200"
                }`}
              >
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-muted/30">
              ...
              <TableHead className="text-xs font-semibold">Target ID</TableHead>
            ...
            {loading ? (
              ...
              data.logs.map((log) => (
                ...
                >
                    ...
                    <div className="flex items-center gap-1.5">
                      <div
                        className={`h-1.5 w-1.5 rounded-full ${
                          ACTOR_TYPE_ICONS[log.actor_type] || "bg-slate-400"
                        }`}
                      />
                      <Badge
                        variant="outline"
                      ...
                      {log.actor_id && (
                        <IdCell id={log.actor_id} onViewUser={handleViewUser} />
                      )}
                    </div>
                  </TableCell>
                  ...
                  <TableCell>
                    <IdCell id={log.target_id} onViewUser={handleViewUser} />
                  </TableCell>
                  <TableCell>
      ...
      {data && data.total_pages > 1 && (
        <div className="flex items-center justify-between">
          <span className="text-xs text-muted-foreground">
            Showing page {data.page} of {data.total_pages} ({data.total.toLocaleString()} total)
          </span>
