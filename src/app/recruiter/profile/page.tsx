    ...
    <div>
        ...
        <div className="bg-card rounded-2xl border border-border mt-6 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="text-sm text-brand-hover hover:text-brand-active font-medium">
              Manage Team
            </button>
          </div>
        ...
        <div className="bg-gradient-to-r from-brand-light to-brand-soft rounded-2xl border border-brand-muted mt-6 p-6">
          <div className="flex items-center justify-between">
            ...
            <button className="px-4 py-2 bg-brand text-white text-sm font-medium rounded-lg hover:bg-brand-hover transition-all">
              Upgrade
            </button>
          </div>
        </div>
