...
const PROFESSION_BG: Record<string, string> = {
  ...
  Cinematographer: "bg-violet-100 text-violet-700",
  Editor: "bg-violet-100 text-violet-700",
  Choreographer: "bg-indigo-100 text-indigo-700",
  "Makeup Artist": "bg-teal-100 text-teal-700",
  Stylist: "bg-teal-100 text-teal-700",
  Producer: "bg-amber-100 text-amber-700",
  Comedian: "bg-fuchsia-100 text-fuchsia-700",
  "Child Artist": "bg-fuchsia-100 text-fuchsia-700",
  "Other Creative Roles": "bg-slate-100 text-slate-700",
};
