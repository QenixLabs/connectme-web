    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md text-center">
          <p className="text-slate-600">No email provided. Please use the signup link.</p>
          <Link href="/auth/talent/signup" className="text-amber-600 hover:text-amber-700 font-medium mt-4 inline-block">
            Go to Signup
          </Link>
        </div>
      </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          <div className="px-8 py-8">
            ...
            {resendSuccess && (
              <div className="mb-4 flex items-start gap-2.5 bg-emerald-50 border border-emerald-200 text-emerald-700 rounded-lg px-4 py-3 text-sm">
                <svg className="w-4 h-4 mt-0.5 flex-shrink-0" viewBox="0 0 16 16" fill="none">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="000000"
                  className="w-full h-12 px-4 rounded-lg border border-slate-200 bg-slate-50 text-slate-900 text-lg text-center tracking-widest placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:bg-white transition-all"
                  maxLength={6}
                />
                <p className="text-xs text-slate-400 mt-2">Enter the 6-digit code from your email</p>
              </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center">
                <span className="bg-white px-3 text-xs text-slate-400">Didn't receive the code?</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full h-11 rounded-lg border border-slate-200 text-slate-600 text-sm font-medium hover:bg-slate-50 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {resendLoading ? (
                <>
                  <svg className="w-4 h-4 animate-spin" viewBox="0 0 16 16" fill="none">
