...
const NAV_ITEMS = [
  { href: "/talent/dashboard", label: "Home", icon: HomeIcon },
  { href: "/talent/opportunities", label: "Jobs", icon: BriefcaseIcon },
  { href: "/talent/messages", label: "Messages", icon: MessageIcon },
  { href: "/talent/profile", label: "Profile", icon: ProfileIcon },
];
    ...
    <div className="min-h-screen bg-page flex flex-col">
      ...
      <header className="bg-card border-b border-border px-4 py-3 sticky top-0 z-40">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <Link href="/talent/dashboard" className="text-lg font-bold text-text-primary">
