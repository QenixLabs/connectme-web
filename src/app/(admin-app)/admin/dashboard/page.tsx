      ...
      >
        <motion.div variants={item}>
          <StatCard
            ...
            icon={Users}
            accentClass="border-l-primary bg-primary/10 text-primary"
          />
        </motion.div>
        <motion.div variants={item}>
          <StatCard
            ...
            icon={ShieldCheck}
            accentClass="border-l-gold bg-gold/10 text-gold"
          />
        </motion.div>
        <motion.div variants={item}>
          <StatCard
            ...
            icon={FolderKanban}
            accentClass="border-l-green bg-green/10 text-green"
          />
        </motion.div>
        <motion.div variants={item}>
          <StatCard
            ...
            icon={FileSearch}
            accentClass="border-l-rose bg-rose/10 text-rose"
          />
        </motion.div>
      </motion.div>
