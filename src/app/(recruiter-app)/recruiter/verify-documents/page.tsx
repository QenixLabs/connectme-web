...
const steps = [
  {
    ...
    desc: "Upload both sides of your company proof",
    icon: Upload,
    ...
    <div className="min-w-0">
      ...
      {!verification && (
        <div className="mt-8 flex flex-col items-center justify-center rounded-2xl border border-border bg-surface p-10 text-center">
          ...
          <h2 className="mt-5 text-xl font-extrabold">Start Company Verification</h2>
          <p className="mt-2 max-w-sm text-sm text-muted-foreground">
            Verify your company to build trust with talents and unlock premium features.
          </p>
          <button
          ...
          <div className="min-w-0 space-y-5">
            ...
            <section className="panel p-5">
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                {uploadedCount === 0
                  ? "Upload both sides of your company proof to continue."
                  : uploadedCount === 1
            ...
            <section className="panel p-5">
              <h2 className="text-lg font-bold">
                1. Company Proof <span className="text-primary">(Required)</span>
              </h2>
            ...
            <section className="panel grid gap-5 p-5 md:grid-cols-[minmax(0,1fr)_auto] md:items-center">
              <div className="min-w-0">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Add GST Certificate, PAN Card, Incorporation Certificate or any other document.
                </p>
              </div>
